...
# City table mapped to City class here, all columns mapped to attributes of that class
# Each record in the City table is an instance of the City object
...
# Foreign key:  Location.CITY_ID -> Location.city
